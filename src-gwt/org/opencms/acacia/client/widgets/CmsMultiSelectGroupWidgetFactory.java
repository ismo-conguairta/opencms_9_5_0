 ...
 */
public class CmsMultiSelectGroupWidgetFactory implements I_CmsWidgetFactory, I_CmsHasInit {

    /** The widget name. */
    private static final String WIDGET_NAME = "org.opencms.widgets.CmsMultiSelectGroupWidget";
    ...
    public static void initClass() {
        ...
        WidgetRegistry.getInstance().registerWidgetFactory(WIDGET_NAME, new CmsMultiSelectGroupWidgetFactory());
    }
    ...
    public I_CmsFormEditWidget createFormWidget(String configuration) {
        ...
        return new CmsFormWidgetWrapper(new CmsMultiSelectWidget(configuration));
    }
