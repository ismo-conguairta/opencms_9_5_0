...
/**
 * Menu item rule which is only active if the current context is the GWT edit provider.<p>
 */
public class CmsMirEditProviderActive extends A_CmsMenuItemRule {

    /** List of contexts used for matching. */
    private static List<String> contexts = Lists.newArrayList(I_CmsMenuItemRule.CONTEXT_EDITPROVIDER);
